 ...
 */
    .controller('AssociateCtrl', ['$scope', 'RequestService', 'session', '$filter', 'DetailedAssociateService', 'notify', associateController])
    .controller('BadgeCtrl', ['$scope', 'toastr', 'session', 'DetailedAssociateService', badgeController]);
