...
angular
    ...
    .controller('LocationCtrl', ['$scope', 'LocationService', 'notify', locationController])
    .controller('ModalLocationCtrl', ['$scope', '$uibModal', 'LocationService', locationModalController])
    .controller('ModalLocationInstanceCtrl', ['$scope', '$uibModalInstance', 'location', 'players', 'RequestService', '$rootScope', 'session', 'notify', locationModalInstanceController]);
 ...
 * @method locationModalController
 * @param {object} $scope
 * @param {object} $uibModal
 * @param {service} LocationService
 */
function locationModalController($scope, $uibModal, LocationService) {
...
/**
 * @method locationModalInstanceController
 * @param {object} $scope
 ...
 * @param {object} notify
 */
function locationModalInstanceController($scope, $uibModalInstance, location, players, RequestService, $rootScope, session, notify) {
