...
angular
    ...
    .controller('BeaconCtrl', ['$scope', 'RequestService', 'session', 'notify', beaconController])
    .controller('ModalBeaconCtrl', ['$scope', '$uibModal', beaconModalController])
    .controller('ModalBeaconInstanceCtrl', ['$scope', '$uibModalInstance', 'beacon', 'beacons', 'RequestService', 'session', 'notify', beaconModalInstanceController])
    .controller('BeaconAlertCtrl', ['$scope', 'sweet', 'RequestService', alertController])
    .controller('UploadCtrl', ['$scope', 'Upload', '$timeout', 'DEFAULT_BACKEND_CONFIG', 'session', 'APPLICATION_ID', UploadController]);
 ...
 * @method beaconModalController
 * @param {object} $scope
 * @param {object} $uibModal
 */
function beaconModalController($scope, $uibModal) {
 ...
 * @method beaconModalInstanceController
 * @param {object} $scope
 ...
 * @param {object} notify
 */
function beaconModalInstanceController($scope, $uibModalInstance, beacon, beacons, RequestService, session, notify) {
