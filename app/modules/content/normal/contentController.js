...
angular
    ...
    .controller('ContentCtrl', ['$scope', 'RequestService', 'session', 'notify', 'ContentService', contentController])
    .controller('ModalContentCtrl', ['$scope', '$uibModal', contentModalController])
    .controller('ModalContentInstanceCtrl', ['$scope', '$uibModalInstance', 'content', '$rootScope', 'RequestService', 'contents', 'session', 'notify', '$sce', 'CDNService', 'CDN_CONFIG', contentModalInstanceController])
    .controller('GalleryCtrl', ['$scope', 'Lightbox', '$rootScope', 'session', 'ContentService', '$sce', 'CDN_CONFIG', galleryController])
    .controller('ContentAlertCtrl', ['$scope', 'sweet', alertController])
    .controller('contentDropletCtrl', ['$scope', '$timeout', 'session', 'APPLICATION_ID', 'CDNService', dropletController]);
 ...
 * @method contentModalController
 * @param {object} $scope
 * @param {object} $uibModal
 */
function contentModalController($scope, $uibModal) {
 ...
 * @method contentModalInstanceController
 * @param {object} $scope
 ...
 */
function contentModalInstanceController($scope, $uibModalInstance, content, $rootScope, RequestService, contents, session, notify, $sce, CDNService, CDN_CONFIG) {
