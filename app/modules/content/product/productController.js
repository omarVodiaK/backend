...
angular
    .module('app.product', [])
    .controller('ProductCtrl', ['$scope', 'RequestService', 'session', 'notify', productController])
    .controller('ModalProductCtrl', ['$scope', '$uibModal', productModalController])
    .controller('ModalProductInstanceCtrl', ['$scope', '$uibModalInstance', 'product', '$rootScope', 'RequestService', 'products', '$q', 'session', 'notify', productModalInstanceController])
    .controller('RatingCtrl', ['$scope', ratingController])
    .controller('SubProductCtrl', ['$scope', subProductController])
    .controller('CategoryCtrl', ['$scope', 'RequestService', '$rootScope', 'session', categoryController])
    .controller('ProductDetailCtrl', ['$scope', 'RequestService', 'notify', productDetailController])
    .controller('dropletCtrl', ['$scope', '$timeout', 'RequestService', dropletController])
    .controller('ProductGalleryCtrl', ['$scope', productGalleryController]);
...
function productModalController($scope, $uibModal) {
...
function productModalInstanceController($scope, $uibModalInstance, product, $rootScope, RequestService, products, $q, session, notify) {
