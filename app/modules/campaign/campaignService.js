...
angular
    ...
    .service('ShareData', ['$window', function ($window) {
    ...
    .service('DetailedCampaign', ['RequestService', 'session', function (RequestService, session) {
    ...
    .service('RefreshCampaign', ['RequestService', 'session', function (RequestService, session) {
