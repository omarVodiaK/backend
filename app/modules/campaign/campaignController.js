...
angular
    ...
    .controller('CampaignCtrl', ['$scope', 'ShareData', 'RequestService', 'RefreshCampaign', 'notify', campaignController])
    .controller('PublishCampaignModal', ['$scope', 'session', '$uibModal', 'DetailedAssociateService', publishModalController])
    .controller('PublishCampaignInstanceCtrl', ['$scope', '$uibModalInstance', 'campaign', 'associates', publishCampaignModalController])
    .controller('ModalCampaignCtrl', ['$scope', '$uibModal', campaignModalController])
    .controller('ModalCampaignInstanceCtrl', ['$scope', '$uibModalInstance', 'associates', 'campaign', 'beacon', 'RequestService', 'notify', campaignModalInstanceController])
    .controller('CampaignStepCtrl', ['$scope', 'RequestService', 'session', campaignStepController])
    .controller('CampaignAlertCtrl', ['$scope', 'sweet', 'RequestService', alertController])
    .controller('PopulateFrequencyCtrl', ['$scope', 'RequestService', populateFrequencyController])
    .controller('CampaignBadgeCtrl', ['$scope', 'toastr', 'session', 'DetailedCampaign', campaignBadgeController])
    .controller('UpdateCampaignCtrl', ['$scope', 'ShareData', 'RequestService', 'session', 'RefreshCampaign', 'notify', updateCampaignController])
    //.controller('RedeemCtrl', redeemController)
    .controller('CampaignBadgeCtrl', ['$scope', 'toastr', 'session', 'DetailedCampaign', campaignBadgeController])
    .controller('BeaconContentCtrl', ['$scope', 'RequestService', 'notify', beaconContentController]);
...
function campaignModalController($scope, $uibModal) {
 ...
 * @method campaignModalInstanceController
 * @param {object} $scope
 * @param {object} $uibModalInstance
 * @param {array} associates
 * @param {object} campaign
 ...
 * @param {object} notify
 */
function campaignModalInstanceController($scope, $uibModalInstance, associates, campaign, beacon, RequestService, notify) {
